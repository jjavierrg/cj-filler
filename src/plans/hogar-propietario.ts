...
export default <ICJ>{
  ...
  actions: [
    ...
    { type: ActionType.CLICK, selector: 'app-is-house-insured div[title="Sí"]' },
    { type: ActionType.CLICK, selector: 'app-is-house-insured #Mortgage_0', optional: true, timeout: 500 },
    { type: ActionType.TYPE, selector: 'app-postal-code #div_PostalCode > input', stringValue: '28002' },
    { type: ActionType.WAIT_UNTIL_VALUE, selector: 'app-postal-code #lblCity', stringValue: 'MADRID', timeout: 90000 },
    ...
    { type: ActionType.TYPE, selector: 'app-house-and-land-area #txt_', stringValue: '120' },
    { type: ActionType.CLICK, selector: 'app-house-and-land-area #next' },
    { type: ActionType.SELECT, selector: 'app-number-of-rooms #HouseSection_NumberOfRooms_option', numericValue: 4 },
    { type: ActionType.SELECT, selector: 'app-number-of-rooms #HouseSection_NumberOfBathrooms_option', numericValue: 3 },
    ...
    { type: ActionType.CLICK, selector: 'app-protection-system input[name="checkbox_ArmoredDoor"]' },
    ...
    { type: ActionType.TYPE, selector: 'app-container #txt_', stringValue: '150000' },
    { type: ActionType.CLICK, selector: 'app-container #next' },
    { type: ActionType.TYPE, selector: 'app-content #txt_', stringValue: '40000' },
    ...
    { type: ActionType.TYPE, selector: 'app-holder-dni #txt_NIF', stringValue: '12345678Z' },
