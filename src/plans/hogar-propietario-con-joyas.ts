...
export default <ICJ>{
  name: '[Hogar] - Propietario con joyas',
  actions: [
    {
    ...
    { type: ActionType.CLICK, selector: 'app-is-house-insured div[title="No"]' },
    { type: ActionType.CLICK, selector: 'app-is-house-insured #Mortgage_1', optional: true, timeout: 500 },
    { type: ActionType.TYPE, selector: 'app-postal-code #div_PostalCode > input', stringValue: '03201' },
    { type: ActionType.WAIT_UNTIL_VALUE, selector: 'app-postal-code #lblCity', stringValue: 'ALICANTE', timeout: 90000 },
    ...
    { type: ActionType.SELECT, selector: 'app-construction-year #HouseSection__option', stringValue: '2022' },
    { type: ActionType.CLICK, selector: 'app-construction-year #next' },
    { type: ActionType.TYPE, selector: 'app-house-and-land-area #txt_', stringValue: '82' },
    ...
    { type: ActionType.CLICK, selector: 'app-rehabilitated #span_No' },
    { type: ActionType.CLICK, selector: 'app-protection-system #next' },
    { type: ActionType.TYPE, selector: 'app-container #txt_', stringValue: '63000' },
    { type: ActionType.CLICK, selector: 'app-container #next' },
    { type: ActionType.TYPE, selector: 'app-content #txt_', stringValue: '15000' },
    { type: ActionType.CLICK, selector: 'app-content #next' },
    { type: ActionType.CLICK, selector: 'app-cover-type-multi-option #firstQuestion_1 input' },
    { type: ActionType.TYPE, selector: 'app-cover-type-multi-option #txt_JewelsOutOfSafeBox', stringValue: '300' },
