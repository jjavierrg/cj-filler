...
import { generateRandomEmail, generateRandomName, generateRandomStringBirthDate, generateRandomSurname } from '../services/random';
...
export default <ICJ>{
  ...
  actions: [
    ...
    { type: ActionType.TYPE, selector: 'app-name #name', executeFunc: async (): Promise<string> => generateRandomName() },
    { type: ActionType.TYPE, selector: 'app-name #firstSurName', executeFunc: async (): Promise<string> => generateRandomSurname() },
    { type: ActionType.TYPE, selector: 'app-name #secondSurName', executeFunc: async (): Promise<string> => generateRandomSurname() },
    ...
    { type: ActionType.TYPE, selector: 'cj-process-email-info #email', executeFunc: async (): Promise<string> => generateRandomEmail() },
