...
export default <ICJ>{
  ...
  actions: [
    ...
    { type: ActionType.CLICK, selector: 'make #li_top_Bmw' },
    { type: ActionType.CLICK, selector: 'model #li_SERIE\\ 1' },
    { type: ActionType.CLICK, selector: 'fuel-type #D' },
    { type: ActionType.CLICK, selector: 'power #radio150' },
    { type: ActionType.CLICK, selector: 'doors #radio5' },
    { type: ActionType.CLICK, selector: 'version #radio00130940346' },
    ...
    { type: ActionType.CLICK, selector: 'another-vehicle #divOption2 #radioTwo' },
    {
      ...
      executeFunc: async (): Promise<string> => generateRandomStringBirthDate({ minAge: 30 }),
    },
